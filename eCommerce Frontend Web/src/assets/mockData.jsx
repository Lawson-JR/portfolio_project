...
export const mockData = [
    ...
    { id: 61, image: "", name: "Tropico 6", price: "39.99", genre: "Simulation/Strategy", description: "Build and rule your island nation as the ultimate dictator.", rating: 2 },
    { id: 62, image: "", name: "Anno 1800", price: "49.99", genre: "Simulation/Strategy", description: "Build a thriving industrial empire in the 19th century.", rating: 4 },
    { id: 63, image: "", name: "XCOM 2", price: "19.99", genre: "Strategy", description: "Defend Earth from alien invaders in this tactical turn-based game.", rating: 3 },
    { id: 64, image: "", name: "Total War: Three Kingdoms", price: "49.99", genre: "Strategy", description: "Experience the chaos of the Three Kingdoms period in China.", rating: 4 },
    { id: 65, image: "", name: "StarCraft II", price: "39.99", genre: "Strategy", description: "Lead your faction to victory in this legendary real-time strategy game.", rating: 2 },
    { id: 66, image: "", name: "Planet Coaster", price: "44.99", genre: "Simulation", description: "Build and manage your dream theme park with endless creativity.", rating: 3 },
    { id: 67, image: "", name: "Red Dead Redemption", price: "59.99", genre: "Action/Adventure", description: "Experience life as an outlaw in the American West.", rating: 4 },
    { id: 68, image: "", name: "WWE 2K23", price: "59.99", genre: "Sports", description: "Step into the ring and become a wrestling legend.", rating: 2 },
    { id: 69, image: "", name: "Age of Empires IV", price: "59.99", genre: "Strategy", description: "Build and lead your empire through the ages in this RTS.", rating: 4 },
    ...
    { id: 93, image: "", name: "Cities: Skylines", price: "29.99", genre: "Simulation", description: "Design and manage the city of your dreams.", rating: 2 },
